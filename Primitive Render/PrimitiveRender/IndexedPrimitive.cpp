...
VertexPositionColor IndexedPrimitive::vertices[NUM_VERTS] =
{
	// top vertices of cube  --------------------------------------------------------
	{ Vector3(2.0f, 2.0f, 2.0f), Color(1.0f, 0.0f, 0.0f, 1.0f) },  	// Vertex 0
	{ Vector3(2.0f, 2.0f, -2.0f), Color(0.0f, 1.0f, 0.0f, 1.0f) },	// Vertex 1
	{ Vector3(-2.0f, 2.0f, -2.0f), Color(0.0f, 0.0f, 1.0f, 1.0f) },     	// Vertex 2
	{ Vector3(-2.0f, 2.0f, 2.0f), Color(1.0f, 0.0f, 0.0f, 1.0f) },     	// Vertex 3    

	// bottom vertices of cube  --------------------------------------------------------
	{ Vector3(2.0f, -2.0f, 2.0f), Color(0.0f, 1.0f, 0.0f, 1.0f) },	// Vertex 4
	{ Vector3(2.0f, -2.0f, -2.0f), Color(0.0f, 0.0f, 1.0f, 1.0f) },   	 // Vertex 5             
	{ Vector3(-2.0f, -2.0f, -2.0f), Color(1.0f, 0.0f, 0.0f, 1.0f) },	// Vertex 6
	{ Vector3(-2.0f, -2.0f, 2.0f), Color(0.0f, 1.0f, 0.0f, 1.0f) },	// Vertex 7
};

// the indices
// DWORD is a 32 bit unsigned integer
DWORD IndexedPrimitive::indices[NUM_INDICES] =
{
	0, 2, 1,	// top quad
	0, 3, 2,
	0, 1, 4,	// right quad
